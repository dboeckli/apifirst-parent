...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String @NonNull ... args) {
        ...
        CustomerDto customer1 = CustomerDto.builder()
            .name(NameDto.builder().firstName("John").lastName("Thompson").build())
        ...
        CustomerDto customer2 = CustomerDto.builder()
            .name(NameDto.builder().firstName("Jim").lastName("Smith").build())
        ...
        ProductDto product1 = ProductDto.builder()
            ...
            .cost("12.99")
            .price("14.99")
            .dimensions(DimensionsDto.builder().height(1).length(2).width(3).build())
            .images(List.of(ImageDto.builder().url("http://example.com/image1").altText("Image 1").build()))
            .build();
        ...
        ProductDto product2 = ProductDto.builder()
            ...
            .price("14.99")
            .dimensions(DimensionsDto.builder().height(1).length(2).width(3).build())
            .images(List.of(ImageDto.builder().url("http://example.com/image2").altText("Image 2").build()))
            .build();
